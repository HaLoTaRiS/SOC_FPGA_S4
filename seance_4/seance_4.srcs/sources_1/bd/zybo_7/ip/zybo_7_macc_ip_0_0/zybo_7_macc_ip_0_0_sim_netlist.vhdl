...
architecture STRUCTURE of zybo_7_macc_ip_0_0_macc_ip_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \reg_data_out_reg[7]_i_10\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \reg_data_out_reg[7]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \reg_data_out_reg[7]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \reg_data_out_reg[7]_i_9\ : label is "soft_lutpair2";
...
\reg_data_out_reg[7]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"5D"
    )
        port map (
...
\reg_data_out_reg[7]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
