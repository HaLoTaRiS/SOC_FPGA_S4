...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_macc_ip_v1_0_S00_AXI is
  ...
  signal \j[31]_i_4_n_1\ : STD_LOGIC;
  ...
  signal \j__63\ : STD_LOGIC_VECTOR ( 31 downto 1 );
...
\j[31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\j[31]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
