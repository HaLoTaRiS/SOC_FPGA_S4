...
#
# Generated by Vivado on Sun Jun 05 22:10:56 +0200 2022
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L axi_timer_v2_0_21 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zybo_7 xil_defaultlib.zybo_7 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim zybo_7 -key {Behavioral:sim_1:Functional:zybo_7} -tclbatch cmd.tcl -protoinst "protoinst_files/zybo_7.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zybo_7.wdb xsim.dir)
