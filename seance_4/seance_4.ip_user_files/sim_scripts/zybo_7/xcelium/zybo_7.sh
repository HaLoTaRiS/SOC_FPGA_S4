...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.zybo_7 \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"../../../../seance_4.srcs/sources_1/bd/zybo_7/ipshared/ec67/hdl" \
       +incdir+"../../../../seance_4.srcs/sources_1/bd/zybo_7/ipshared/8c62/hdl" \
       +incdir+"../../../../seance_4.srcs/sources_1/bd/zybo_7/ip/zybo_7_processing_system7_0_0" \
